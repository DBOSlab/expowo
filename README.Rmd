...
An R package for mining plant checklist, diversity estimates, and distribution data 
from RGB Kew’s [Plants of the World Online (POWO)](https://powo.science.kew.org).
...
You can also narrow down the search to focus on just a particular genus from a particular country or a list of genera from a list of countries (please check this [article](https://github.com/domingoscardoso/expowo) for further details)
...
the data available in the POWO's database. You can also narrow down the search to 
...
and distribution data. https://github.com/deborazuanny/expowo


![](vignettes/DBOSlab_logo.png){width=30%}
