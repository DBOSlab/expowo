...
\
```{r, echo = FALSE, out.width = "600px", fig.cap = "FIGURE 1. Accumulation of formally described species in the big genus _Crotalaria_ over time."}
...
The accumulation curve of _Crotalaria_ shows that it has 712 spp. described and a high 
increase of taxonomic changes between 1840 and 1920 (noticeable by the curve in light red).
