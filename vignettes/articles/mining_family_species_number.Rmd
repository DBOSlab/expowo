...
The example below shows how to mine the total species number by defining a vector of four families: __Amborellaceae__, __Cabombaceae__, __Lecythidaceae__, and __Martyniaceae__. The resulting output (TABLE 1) is also saved directly in the specified directory __results_powoFam__.\

```{r, eval = FALSE}
library(taxize)

fam <- c("Amborellaceae", "Cabombaceae", "Lecythidaceae", "Martyniaceae")
...
powoFam(powocodes$family, powocodes$uri,
        ...
        save = TRUE,
        dir = "results_powoFam/",
        filename = "Ambo_Camb_Lecy_Martyniaceae_diversity")
```

```{r, echo = FALSE, warning = FALSE}
utils::data("angioData")
library(taxize)
family <- c("Amborellaceae", "Cabombaceae", "Lecythidaceae", "Martyniaceae")
...
knitr::kable(res,
             row.names = FALSE,
             align = 'c',
             caption = "TABLE 1. A general `powoFam` search for mining the total species number of four angiosperm families.")
```
