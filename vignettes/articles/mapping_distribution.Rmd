...
__global distribution  maps__ of Lecythidaceae's species richness at __botanical countrylevel__, which are distinctly colored by `Viridis` and `RColorBrewer` color palettes.\
