...
thld <- 500
family <- c("Aristolochiaceae", "Begoniaceae", "Piperaceae", "Solanaceae")
gens <- angioData$genus[angioData$family %in% family]
species <- table(gens)
species <- as.data.frame(species)
species <- species %>% filter(species$Freq >= thld)
genus <- as.character(species$gens)
species_number <- species$Freq
authors <- c("L.", "L.", "Ruiz & Pav.", "L.", "L.")
scientific_name <- c("Aristolochia L.", "Begonia L.", 
                     "Peperomia Ruiz & Pav.", "Piper L.", "Solanum L.")
powo_uri <- c("https://powo.science.kew.org/taxon/urn:lsid:ipni.org:names:330834-2" , "https://powo.science.kew.org/taxon/urn:lsid:ipni.org:names:327437-2", "https://powo.science.kew.org/taxon/urn:lsid:ipni.org:names:329746-2", "https://powo.science.kew.org/taxon/urn:lsid:ipni.org:names:326982-2", "https://powo.science.kew.org/taxon/urn:lsid:ipni.org:names:30000630-2")
kew_id <- c( "330834-2", "327437-2", "329746-2", "326982-2","30000630-2")
family <- c("Aristolochiaceae", "Begoniaceae", "Piperaceae","Piperaceae",
            "Solanaceae")
