...
uses any numeric value in the argument `thld` to define the threshold for a 
megadiverse genus
...
The function `megaGen` uses a specified threshold number to return a dataframe or 
...
knitr::kable(res,
             caption = "TABLE 1. A general `megaGen` search to mining the megadiverse 
             genera for some specific angiosperm families, based on a specified 
             threshold of 500 species.")
```
