...
The example below shows how to create the global distribution map of _Cariniana_'s 
species richness according to botanical subdivision and colored by the `viridis` 
...
\
\
To create global maps of Lecythidaceae according to botanical subdivision, change 
...
richness at botanical country-level, which are distinctly colored by `Viridis` 
and `RColorBrewer` color palettes.\
...
distribution in the countries and/or botanical regions. The species names must 
...
subdivision level 3, you must indicate in which column this data (e.g., Brazil 
