...
#'         format = "jpg")
#'
#' @param data A padronized data frame of species' global distribution at
#' country or botanical country level either created with the function
#' \code{powoSpecies} or with external sources.
#'
...
#' input data either created with \code{powoSpecies} or in an external
#' spreadsheet. The default of this argument is "native_to_country"
...
#' for Recording Plant Distributions. But then make sure to provide in
#' the argument \code{botctrs} the World's botanical country divisions from
#' \code{\link{botdivmap}}. If the input is generated by external sources, the
#' data and columns of the spreadsheet must match with the standardized
#' output from \code{powoSpecies}.
#'
